...
export class Backend implements backendInterface {
    ...
    async getTopHighScores(arg0: bigint): Promise<Array<HighScoreEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTopHighScores(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async submitHighScore(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitHighScore(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
